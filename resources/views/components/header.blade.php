        ...
        <div class="flex items-center">
            ...
            <div x-data="{ dropdownOpen: false }" class="relative">
                <div class="flex gap-4 items-center">
                    ...
                    <span class="hidden md:flex font-bold items-center">
                        Hello! 
                        {{ Auth::user()->name }}
                    ...
                    <button @click="dropdownOpen = ! dropdownOpen"
                        class="relative block border w-12 h-12 overflow-hidden rounded-full shadow focus:outline-none">
                ...
                <div x-show="dropdownOpen"
                    ...
                    style="display: none;">
                    <a href="#"
                        class="flex gap-2 dark:bg-gray-900  items-center px-4 py-2 text-sm text-gray-700 dark:text-white hover:bg-primary hover:text-white">
                    ...
                    <a href="{{route('logout')}}"
                        class="flex  gap-2 items-center dark:bg-gray-900  px-4 py-2 text-sm text-gray-700 dark:text-white hover:bg-primary hover:text-white">
