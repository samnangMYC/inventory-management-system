                ...
                <form action="{{ route('sub-category.update', $subCategories->id) }}" method="POST">
                    ...
                    <div class=" py-4 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $subCategories->name }}" required />
                        </div>
                     <!--Type of Category  -->
                     ...
                     <!--End Type of Category  -->
                      ...
                      <div class="mb-6">
                        ...
                        <input type="text" value="{{$subCategories->descriptions}}" name="descriptions" id="description" placeholder="lorem" class="block w-full py-4 px-3 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                     </div>
