    ...
    <div class="flex flex-wrap -mx-6 ">
        <div class="w-full px-6 sm:w-1/2 xl:w-1/3 ">
            <section class="bg-white rounded-md">
                <div class="flex items-center px-5 py-6 dark:bg-gray-900  shadow-sm">
                    <div class="p-3 bg-indigo-600 bg-opacity-75 rounded-full dark:text-white ">
        ...
        <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
            ...
            <div class="flex items-center px-5 py-6 dark:bg-gray-900 shadow-sm">
                ...
                <div class="mx-5">
                    <h4 class="text-2xl font-semibold text-gray-700 dark:text-white">{{ $totalSale}}</h4>
                    <div class="text-gray-500 dark:text-slate-300">Total Sales</div>
                </div>
            </div>
        </div>
        </section>
