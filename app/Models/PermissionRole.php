...
class PermissionRole extends Model
{
    ...
    static public function getPermission($slug,$role_id): int{
    ...
    public function getPermissionCount($role_id)
    {
        $count = PermissionRole::where('role_id', $role_id)->count('permission_id');
        return $count;
    }
}
